...
internal static class Program
{
	...
	private static void AddResxKey(string key)
	{
		var values = key switch
		{
			...
			"AddPhrase" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Afegir frase",
				["cs-CZ"]   = "Přidat frázi",
				["cy-GB"]   = "Ychwanegu Ymadrodd",
				["da-DK"]   = "Tilføj sætning",
				["de-DE"]   = "Phrase hinzufügen",
				["es-ES"]   = "Añadir frase",
				["es-MX"]   = "Agregar frase",
				["fi-FI"]   = "Lisää lause",
				["fr-CA"]   = "Ajouter une phrase",
				["fr-FR"]   = "Ajouter une phrase",
				["he-IL"]   = "הוסף ביטוי",
				["hu-HU"]   = "Mondat hozzáadása",
				["hy-AM"]   = "Ավելացնել արտահայտություն",
				["it-IT"]   = "Aggiungi frase",
				["ja-JP"]   = "フレーズを追加",
				["nb-NO"]   = "Legg til setning",
				["nl-NL"]   = "Zin toevoegen",
				["pl-PL"]   = "Dodaj frazę",
				["pt-BR"]   = "Adicionar frase",
				["pt-PT"]   = "Adicionar frase",
				["ro-RO"]   = "Adaugă frază",
				["ru-RU"]   = "Добавить фразу",
				["sv-SE"]   = "Lägg till fras",
				["th-TH"]   = "เพิ่มวลี",
				["tr-TR"]   = "İfade ekle",
				["uk-UA"]   = "Додати фразу",
				["zh-Hans"] = "添加短语",
			},
			"CommentaryPhrases_UC" => new Dictionary<string, string>
			{
				["ca-ES"]   = "FRASES DEL COMENTARI",
				["cs-CZ"]   = "KOMENTÁŘOVÉ FRÁZE",
				["cy-GB"]   = "YMADRODDION SYLWEBAETH",
				["da-DK"]   = "KOMMENTARSÆTNINGER",
				["de-DE"]   = "KOMMENTAR-PHRASEN",
				["es-ES"]   = "FRASES DE COMENTARIO",
				["es-MX"]   = "FRASES DE COMENTARIO",
				["fi-FI"]   = "KOMMENTTILAUSEET",
				["fr-CA"]   = "PHRASES DE COMMENTAIRE",
				["fr-FR"]   = "PHRASES DE COMMENTAIRE",
				["he-IL"]   = "ביטויי פרשנות",
				["hu-HU"]   = "KOMMENTÁR MONDATOK",
				["hy-AM"]   = "ՄԵԿՆԱԲԱՆՈՒԹՅԱՆ ԱՐՏԱՀԱՅՏՈՒԹՅՈՒՆՆԵՐ",
				["it-IT"]   = "FRASI DEL COMMENTO",
				["ja-JP"]   = "実況フレーズ",
				["nb-NO"]   = "KOMMENTARSETNINGER",
				["nl-NL"]   = "COMMENTAAR ZINNEN",
				["pl-PL"]   = "FRAZY KOMENTARZA",
				["pt-BR"]   = "FRASES DE COMENTÁRIO",
				["pt-PT"]   = "FRASES DE COMENTÁRIO",
				["ro-RO"]   = "FRAZE COMENTARIU",
				["ru-RU"]   = "ФРАЗЫ КОММЕНТАТОРА",
				["sv-SE"]   = "KOMMENTARSFRASER",
				["th-TH"]   = "วลีบรรยาย",
				["tr-TR"]   = "YORUM İFADELERİ",
				["uk-UA"]   = "ФРАЗИ КОМЕНТАТОРА",
				["zh-Hans"] = "解说短语",
			},
			"EditCommentaryPhrasesDescription" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Personalitzeu les frases que es diuen per a cada esdeveniment en l'idioma seleccionat. Els canvis es desen a la carpeta Documents i substitueixen les frases integrades.",
				["cs-CZ"]   = "Přizpůsobte fráze vyslovované pro každou událost ve vybraném jazyce. Změny se ukládají do složky Dokumenty a přepisují vestavěné fráze.",
				["cy-GB"]   = "Addasu'r ymadroddion a siaredir ar gyfer pob digwyddiad yn yr iaith a ddewiswyd. Caiff newidiadau eu cadw i'ch ffolder Dogfennau ac maent yn disodli'r ymadroddion adeiledig.",
				["da-DK"]   = "Tilpas de sætninger, der tales for hver begivenhed på det valgte sprog. Ændringer gemmes i mappen Dokumenter og tilsidesætter de indbyggede sætninger.",
				["de-DE"]   = "Passen Sie die Phrasen an, die für jedes Ereignis in der ausgewählten Sprache gesprochen werden. Änderungen werden im Ordner Dokumente gespeichert und überschreiben die integrierten Phrasen.",
				["es-ES"]   = "Personaliza las frases que se hablan para cada evento en el idioma seleccionado. Los cambios se guardan en tu carpeta Documentos y reemplazan las frases integradas.",
				["es-MX"]   = "Personaliza las frases que se hablan para cada evento en el idioma seleccionado. Los cambios se guardan en tu carpeta Documentos y reemplazan las frases integradas.",
				["fi-FI"]   = "Mukauta lauseet, jotka puhutaan jokaiselle tapahtumalle valitussa kielessä. Muutokset tallennetaan Asiakirjat-kansioon ja korvaavat sisäänrakennetut lauseet.",
				["fr-CA"]   = "Personnalisez les phrases prononcées pour chaque événement dans la langue sélectionnée. Les modifications sont enregistrées dans votre dossier Documents et remplacent les phrases intégrées.",
				["fr-FR"]   = "Personnalisez les phrases prononcées pour chaque événement dans la langue sélectionnée. Les modifications sont enregistrées dans votre dossier Documents et remplacent les phrases intégrées.",
				["he-IL"]   = "התאם אישית את הביטויים המדוברים עבור כל אירוע בשפה הנבחרת. שינויים נשמרים בתיקיית המסמכים שלך ומחליפים את הביטויים המובנים.",
				["hu-HU"]   = "Testreszabhatja a kiválasztott nyelvben az egyes eseményekre kimondott mondatokat. A változtatások a Dokumentumok mappába kerülnek mentésre, és felülírják a beépített mondatokat.",
				["hy-AM"]   = "Հարմարեցրեք արտահայտությունները, որոնք արտասանվում են յուրաքանչյուր իրադարձության համար ընտրված լեզվով: Փոփոխությունները պահվում են Փաստաթղթեր թղթապանակում և փոխարինում են ներկառուցված արտահայտությունները:",
				["it-IT"]   = "Personalizza le frasi pronunciate per ogni evento nella lingua selezionata. Le modifiche vengono salvate nella cartella Documenti e sovrascrivono le frasi integrate.",
				["ja-JP"]   = "選択した言語で各イベントに話されるフレーズをカスタマイズします。変更はドキュメントフォルダーに保存され、組み込みフレーズを上書きします。",
				["nb-NO"]   = "Tilpass setningene som sies for hvert hendelse på det valgte språket. Endringer lagres i mappen Dokumenter og overstyrer de innebygde setningene.",
				["nl-NL"]   = "Pas de zinnen aan die worden gesproken voor elke gebeurtenis in de geselecteerde taal. Wijzigingen worden opgeslagen in de map Documenten en overschrijven de ingebouwde zinnen.",
				["pl-PL"]   = "Dostosuj frazy mówione dla każdego zdarzenia w wybranym języku. Zmiany są zapisywane w folderze Dokumenty i zastępują wbudowane frazy.",
				["pt-BR"]   = "Personalize as frases faladas para cada evento no idioma selecionado. As alterações são salvas na pasta Documentos e substituem as frases integradas.",
				["pt-PT"]   = "Personalize as frases faladas para cada evento no idioma selecionado. As alterações são guardadas na pasta Documentos e substituem as frases integradas.",
				["ro-RO"]   = "Personalizați frazele rostite pentru fiecare eveniment în limba selectată. Modificările sunt salvate în dosarul Documente și înlocuiesc frazele încorporate.",
				["ru-RU"]   = "Настройте фразы, произносимые для каждого события на выбранном языке. Изменения сохраняются в папке «Документы» и заменяют встроенные фразы.",
				["sv-SE"]   = "Anpassa fraserna som talas för varje händelse på det valda språket. Ändringar sparas i mappen Dokument och åsidosätter de inbyggda fraserna.",
				["th-TH"]   = "ปรับแต่งวลีที่พูดสำหรับแต่ละเหตุการณ์ในภาษาที่เลือก การเปลี่ยนแปลงจะถูกบันทึกในโฟลเดอร์เอกสารของคุณและแทนที่วลีที่ฝังตัว",
				["tr-TR"]   = "Seçilen dilde her etkinlik için söylenen ifadeleri özelleştirin. Değişiklikler Belgeler klasörünüze kaydedilir ve yerleşik ifadelerin yerine geçer.",
				["uk-UA"]   = "Налаштуйте фрази, що вимовляються для кожної події у вибраній мові. Зміни зберігаються в папці «Документи» та замінюють вбудовані фрази.",
				["zh-Hans"] = "自定义所选语言中每个事件的朗读短语。更改将保存到您的文档文件夹，并覆盖内置短语。",
			},
			"EnableXsrcIntegration" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Activa la integració de control de curses Xtreme Scoring",
				["cs-CZ"]   = "Povolit integraci Xtreme Scoring Race Control",
				["cy-GB"]   = "Galluogi Integreiddiad Rheoli Ras Xtreme Scoring",
				["da-DK"]   = "Aktiver Xtreme Scoring Race Control-integration",
				["de-DE"]   = "Xtreme Scoring Race Control-Integration aktivieren",
				["es-ES"]   = "Activar integración de control de carreras Xtreme Scoring",
				["es-MX"]   = "Activar integración de control de carreras Xtreme Scoring",
				["fi-FI"]   = "Ota käyttöön Xtreme Scoring Race Control -integraatio",
				["fr-CA"]   = "Activer l'intégration Xtreme Scoring Race Control",
				["fr-FR"]   = "Activer l'intégration Xtreme Scoring Race Control",
				["he-IL"]   = "הפעל אינטגרציית בקרת מרוצים של Xtreme Scoring",
				["hu-HU"]   = "Xtreme Scoring Race Control integráció engedélyezése",
				["hy-AM"]   = "Միացնել Xtreme Scoring Race Control ինտեգրումը",
				["it-IT"]   = "Abilita integrazione Xtreme Scoring Race Control",
				["ja-JP"]   = "Xtreme Scoring Race Control 連携を有効にする",
				["nb-NO"]   = "Aktiver Xtreme Scoring Race Control-integrering",
				["nl-NL"]   = "Xtreme Scoring Race Control-integratie inschakelen",
				["pl-PL"]   = "Włącz integrację Xtreme Scoring Race Control",
				["pt-BR"]   = "Ativar integração do Xtreme Scoring Race Control",
				["pt-PT"]   = "Ativar integração do Xtreme Scoring Race Control",
				["ro-RO"]   = "Activați integrarea Xtreme Scoring Race Control",
				["ru-RU"]   = "Включить интеграцию Xtreme Scoring Race Control",
				["sv-SE"]   = "Aktivera Xtreme Scoring Race Control-integration",
				["th-TH"]   = "เปิดใช้การรวม Xtreme Scoring Race Control",
				["tr-TR"]   = "Xtreme Scoring Race Control entegrasyonunu etkinleştir",
				["uk-UA"]   = "Увімкнути інтеграцію Xtreme Scoring Race Control",
				["zh-Hans"] = "启用 Xtreme Scoring 赛事控制集成",
			},
			"PhraseEditorResetAll" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Totes les frases s'han restablert als valors predeterminats integrats.",
				["cs-CZ"]   = "Všechny fráze byly obnoveny na vestavěné výchozí hodnoty.",
				["cy-GB"]   = "Ailosodwyd pob ymadrodd i'r rhagosodiadau adeiledig.",
				["da-DK"]   = "Alle sætninger er nulstillet til de indbyggede standarder.",
				["de-DE"]   = "Alle Phrasen wurden auf die integrierten Standardwerte zurückgesetzt.",
				["es-ES"]   = "Todas las frases restablecidas a los valores predeterminados integrados.",
				["es-MX"]   = "Todas las frases restablecidas a los valores predeterminados integrados.",
				["fi-FI"]   = "Kaikki lauseet palautettu sisäänrakennettuihin oletusarvoihin.",
				["fr-CA"]   = "Toutes les phrases ont été réinitialisées aux valeurs par défaut intégrées.",
				["fr-FR"]   = "Toutes les phrases ont été réinitialisées aux valeurs par défaut intégrées.",
				["he-IL"]   = "כל הביטויים אופסו לברירות המחדל המובנות.",
				["hu-HU"]   = "Minden mondat visszaállítva a beépített alapértékekre.",
				["hy-AM"]   = "Բոլոր արտահայտությունները վերականգնվել են ներկառուցված կանխադրած արժեքներին:",
				["it-IT"]   = "Tutte le frasi ripristinate ai valori predefiniti integrati.",
				["ja-JP"]   = "すべてのフレーズが組み込みのデフォルト値にリセットされました。",
				["nb-NO"]   = "Alle setninger er tilbakestilt til de innebygde standardene.",
				["nl-NL"]   = "Alle zinnen zijn teruggezet naar de ingebouwde standaardwaarden.",
				["pl-PL"]   = "Wszystkie frazy zresetowane do wbudowanych wartości domyślnych.",
				["pt-BR"]   = "Todas as frases redefinidas para os padrões integrados.",
				["pt-PT"]   = "Todas as frases repostas para os valores predefinidos integrados.",
				["ro-RO"]   = "Toate frazele au fost resetate la valorile implicite integrate.",
				["ru-RU"]   = "Все фразы сброшены до встроенных значений по умолчанию.",
				["sv-SE"]   = "Alla fraser har återställts till de inbyggda standardvärdena.",
				["th-TH"]   = "วลีทั้งหมดถูกรีเซ็ตเป็นค่าเริ่มต้นที่ฝังอยู่",
				["tr-TR"]   = "Tüm ifadeler yerleşik varsayılanlara sıfırlandı.",
				["uk-UA"]   = "Усі фрази скинуто до вбудованих значень за замовчуванням.",
				["zh-Hans"] = "所有短语已重置为内置默认值。",
			},
			"PhraseEditorSaved" => new Dictionary<string, string>
			{
				["ca-ES"]   = "✔  Frases personalitzades desades.",
				["cs-CZ"]   = "✔  Vlastní fráze uloženy.",
				["cy-GB"]   = "✔  Ymadroddion personol wedi'u cadw.",
				["da-DK"]   = "✔  Brugerdefinerede sætninger gemt.",
				["de-DE"]   = "✔  Benutzerdefinierte Phrasen gespeichert.",
				["es-ES"]   = "✔  Frases personalizadas guardadas.",
				["es-MX"]   = "✔  Frases personalizadas guardadas.",
				["fi-FI"]   = "✔  Mukautetut lauseet tallennettu.",
				["fr-CA"]   = "✔  Phrases personnalisées enregistrées.",
				["fr-FR"]   = "✔  Phrases personnalisées enregistrées.",
				["he-IL"]   = "✔  ביטויים מותאמים אישית נשמרו.",
				["hu-HU"]   = "✔  Egyéni mondatok mentve.",
				["hy-AM"]   = "✔  Հատուկ արտահայտությունները պահպանվել են:",
				["it-IT"]   = "✔  Frasi personalizzate salvate.",
				["ja-JP"]   = "✔  カスタムフレーズを保存しました。",
				["nb-NO"]   = "✔  Egendefinerte setninger lagret.",
				["nl-NL"]   = "✔  Aangepaste zinnen opgeslagen.",
				["pl-PL"]   = "✔  Niestandardowe frazy zapisane.",
				["pt-BR"]   = "✔  Frases personalizadas salvas.",
				["pt-PT"]   = "✔  Frases personalizadas guardadas.",
				["ro-RO"]   = "✔  Fraze personalizate salvate.",
				["ru-RU"]   = "✔  Пользовательские фразы сохранены.",
				["sv-SE"]   = "✔  Anpassade fraser sparade.",
				["th-TH"]   = "✔  บันทึกวลีที่กำหนดเองแล้ว",
				["tr-TR"]   = "✔  Özel ifadeler kaydedildi.",
				["uk-UA"]   = "✔  Користувацькі фрази збережено.",
				["zh-Hans"] = "✔  自定义短语已保存。",
			},
			"PhraseSearch" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Cerca...",
				["cs-CZ"]   = "Hledat...",
				["cy-GB"]   = "Chwilio...",
			...
			"RemovePhrase" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Elimina",
				["cs-CZ"]   = "Odebrat",
				["cy-GB"]   = "Dileu",
			...
			"ResetAllPhrases" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Restableix-les totes",
				["cs-CZ"]   = "Obnovit vše",
				["cy-GB"]   = "Ailosod Pob Un",
				["da-DK"]   = "Nulstil alle",
				["de-DE"]   = "Alle zurücksetzen",
				["es-ES"]   = "Restablecer todo",
				["es-MX"]   = "Restablecer todo",
				["fi-FI"]   = "Palauta kaikki",
				["fr-CA"]   = "Tout réinitialiser",
				["fr-FR"]   = "Tout réinitialiser",
				["he-IL"]   = "אפס הכל",
				["hu-HU"]   = "Összes visszaállítása",
				["hy-AM"]   = "Վերականգնել բոլորը",
				["it-IT"]   = "Reimposta tutto",
				["ja-JP"]   = "すべてリセット",
				["nb-NO"]   = "Tilbakestill alle",
				["nl-NL"]   = "Alles opnieuw instellen",
				["pl-PL"]   = "Zresetuj wszystko",
				["pt-BR"]   = "Redefinir tudo",
				["pt-PT"]   = "Repor tudo",
				["ro-RO"]   = "Resetează tot",
				["ru-RU"]   = "Сбросить всё",
				["sv-SE"]   = "Återställ alla",
				["th-TH"]   = "รีเซ็ตทั้งหมด",
				["tr-TR"]   = "Tümünü sıfırla",
				["uk-UA"]   = "Скинути всі",
				["zh-Hans"] = "重置全部",
			},
			"ResetEventPhrases" => new Dictionary<string, string>
			{
				["ca-ES"]   = "Restableix",
				["cs-CZ"]   = "Obnovit",
				["cy-GB"]   = "Ailosod",
