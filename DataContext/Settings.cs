...
public class Settings : INotifyPropertyChanged
{
	...
	private string _racingWheel_MattsDeltaForceString = string.Empty;

	[XmlIgnore]
	public string RacingWheel_MattsDeltaForceString
	{
		get => _racingWheel_MattsDeltaForceString;

		set
		{
			if (value != _racingWheel_MattsDeltaForceString)
			{
				_racingWheel_MattsDeltaForceString = value;
				OnPropertyChanged();
			}
		}
	}
    ...
    private float racingWheel_Matts_DeltaForce = 3;

	public float RacingWheel_Matts_DeltaForce 
	{ 
		get => racingWheel_Matts_DeltaForce;
		set
		{
			
			value = Math.Clamp( value, 0.1f, 20);
			if (value != racingWheel_Matts_DeltaForce)
			{
				racingWheel_Matts_DeltaForce = value;
				OnPropertyChanged();
			}
            ...
            RacingWheel_MattsDeltaForceString = $"{racingWheel_Matts_DeltaForce:00.00}";
        }


	}

    public ContextSwitches RacingWheel_Matts_DeltaForce_ContextSwitches { get; set; } = new(true, true, false, false, false);
    public ButtonMappings RacingWheel_Matts_DeltaForce_PlusButtonMapping { get; set; } = new ();
    public ButtonMappings RacingWheel_Matts_DeltaForce_MinusButtonMapping { get; set; } = new();


    private string _racingWheel_MattsMinForceString = string.Empty;

    [XmlIgnore]
	public string RacingWheel_MattsMinForceString
	{
		get => _racingWheel_MattsMinForceString;

		set
		{
			if (value != _racingWheel_MattsMinForceString)
			{
				_racingWheel_MattsMinForceString = value;
				OnPropertyChanged();
			}
		}
	}

    private float racingWheel_Matts_MinValue = .1f;

    public float RacingWheel_Matts_MinValue
    {
        get => racingWheel_Matts_MinValue;
        set
        {
            value = Math.Clamp(value, 0, 1);
            if (value != racingWheel_Matts_MinValue)
            {
                racingWheel_Matts_MinValue = value;
                OnPropertyChanged();
            }
            ...
            RacingWheel_MattsMinForceString = $"{racingWheel_Matts_MinValue:0.00}";
        }


    }

    public ContextSwitches RacingWheel_Matts_MinValue_ContextSwitches { get; set; } = new(true, true, false, false, false);
    public ButtonMappings RacingWheel_Matts_MinValue_PlusButtonMapping { get; set; } = new();
    public ButtonMappings RacingWheel_Matts_MinValue_MinusButtonMapping { get; set; } = new();
